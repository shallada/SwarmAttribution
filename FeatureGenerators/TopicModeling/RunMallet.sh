...
mallet-2.0.8/bin/mallet train-topics  --input ../../Concatenator/$1/MalletWork/TopicModeling.mallet --num-topics 45 --output-doc-topics ../../Concatenator/$1/MalletWork/Topics.mallet

python ExtractFeatures.py $1
